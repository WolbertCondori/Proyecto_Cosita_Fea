...
class UserAdmin(admin.ModelAdmin):
    list_display = ('nombre','email','telefono','nie','nc','rol','fecha_nacimiento','edad','img','actualizado') # Esto es las columnas en mi panel de administración
    ...
    ("Configuracion", {'fields': ('password','rol','img')})
    )
